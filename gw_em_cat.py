...
for i in range(len(gw_catalog)):

    print("Simulating event", i)

    gw_row = gw_catalog.iloc[i:i+1]
    ...
    while not detected and attempts < MAX_ATTEMPTS:
        ...
        # =========================================
        # EM DETECTABILITY FIRST (CHEAPER)
        # =========================================
...
detected_df.to_csv("detected_catalog_gw-em-1.csv", index=False)
