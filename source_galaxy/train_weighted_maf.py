...
log10_mstar = data_array[:, 1]

weights = 10**log10_mstar
#alpha = 0.5  
...
data_array_weighted = data_array[idx]
...
model_name = "trained_de_weighted_mass_b32_h128_e1000_sizen"
...
sample.to_csv(f"sample_from_{model_name}.csv", index=False)