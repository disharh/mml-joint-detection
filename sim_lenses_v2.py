...
max_system_attempts = 1000
max_lens_attempts = 1000
max_gw_attempts = 1000
...
while n_det < n_systems and system_attempts < max_system_attempts:
    ...
    filename = f'two_im/System_{n_det}_v2_ex.yaml'
